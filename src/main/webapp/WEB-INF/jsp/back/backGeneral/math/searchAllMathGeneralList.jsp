...
<body>
  <div class="panel admin-panel">
    ...
    <form method="get" action="back/backGeneral/math/searchAllMathGeneralList.html" id="listform">
    <div class="padding border-bottom">
      <ul class="search" style="padding-left:10px;">
        <li> <a class="button border-main icon-plus-square-o" href="${pageContext.request.contextPath}/back/backGeneral/math/addMathGeneral.html"> 添加内容</a> 
            <a class="button border-main icon-plus-square-o" href="${pageContext.request.contextPath}/back/backGeneral/addVideoMore.html?type=1"> 添加专题</a>
        </li>
         <li>
...
$(function(){
	...
	window.location.href="${pageContext.request.contextPath}/back/deleteMathGeneralByid?gid="+gid+"&isMore="+isMore;		
	});
	$(".border-up").on("click",function(){
		...
		if(isMore==1){//多关联
			...
			window.location.href="${pageContext.request.contextPath}/back/backGeneral/math/updateMathGeneral.html?gid="+gid;
		}
		
	});
})
function pageSize(num){
window.location.href="${pageContext.request.contextPath}/back/backGeneral/math/searchAllMathGeneralList.html?gclass="+"${map['gclass']}"+"&"+"gclassify="+"${map['gclassify']}"+"&"+"pageNo="+num;
		}
//添加单元/章节测试题		
function addUnitTest(vid,vname,isMore){
  if(isMore&&isMore==1){//专题多集
	  window.location.href="${pageContext.request.contextPath}/back/backGeneral/addUnitTestMore.html?vid="+vid+"&type=0&vname="+vname+"&typeName=数学";
  }else{//内容单集
	  window.location.href="${pageContext.request.contextPath}/back/backGeneral/addUnitTest.html?vid="+vid+"&type=0&vname="+vname+"&typeName=数学";
  }
}	
</script>
</body>
