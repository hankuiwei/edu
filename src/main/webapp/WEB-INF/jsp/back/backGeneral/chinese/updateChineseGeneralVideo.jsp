...
<div class="panel admin-panel">
  <div class="panel-head" id="add"><strong><span class="icon-pencil-square-o"></span>修改常规语文课程</strong></div>
  <div class="body-content">
    <form method="post" class="form-x" onsubmit="return sub()"  enctype="multipart/form-data" action="${pageContext.request.contextPath}/back/chinese/updateGeneralVideo" >  
      <div class="form-group">
      <input type="hidden" value="${generalVideo.gid}" name="gid">
      <input type="hidden" value="语文" name="gsbuject">
        <div class="label">
          <label>课程名称：</label>
        </div>
        <div class="field">
