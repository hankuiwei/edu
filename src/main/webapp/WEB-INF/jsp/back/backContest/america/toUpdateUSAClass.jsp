...
<div class="panel admin-panel">
  <div class="panel-head" id="add"><strong><span class="icon-pencil-square-o"></span>修改美国大联盟杯课程</strong></div>
  <div class="body-content">
    <form method="post" class="form-x" onsubmit="return sub()" enctype="multipart/form-data" action="${pageContext.request.contextPath}/back/updateUSAClass" >  
      <div class="form-group">
      <input type="hidden" value="${contestVideo.cid}" name="cid">
      <input type="hidden" value="美国大联盟杯" name="competitionName">
        <div class="label">
          <label>课程名称：</label>
        </div>
        <div class="field">
       ...
       <div class="field" id="pdf_tab">
        ...
        <div class="form-group">
          ...
          <div class="field">
             ...
             <input type="checkbox" name="cclass" value="三四年级" <c:if test="${contestVideo.cclass.indexOf('三四年级')>-1 }">checked="checked"</c:if>>三四年级
	         <input type="checkbox" name="cclass" value="五六年级" <c:if test="${contestVideo.cclass.indexOf('五六年级')>-1 }">checked="checked"</c:if>>五六年级
            <div class="tips"></div>
          </div>
        </div>
         <div class="form-group">
          ...
          <div class="field">
            <select name="cclassify" class="w50" style="height:36px;line-height:34px;">
              ...
              <option value="专题" <c:if test="${contestVideo.cclassify=='专题' }">selected="selected"</c:if>>专题</option>
              <option value="真题" <c:if test="${contestVideo.cclassify=='真题' }">selected="selected"</c:if>>真题</option>
            </select>
            <div class="tips"></div>
          </div>
        </div>
