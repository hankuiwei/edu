...
<div class="panel admin-panel">
  <div class="panel-head" id="add"><strong><span class="icon-pencil-square-o"></span>增加美国大联盟杯课程</strong></div>
  <div class="body-content">
    <form method="post" class="form-x" onsubmit="return sub()" enctype="multipart/form-data" action="${pageContext.request.contextPath}/back/america/addUSAClass" >  
      <div class="form-group">
       ...
       <div class="firminfo-video">
            <div class="firminfo-video-input">
                ...
                <input type="file" class="videoUp" value="" id="videoUp" style="display: none" data-validate="required:请上传视频" name="file1">
            </div>
        </div>
      </div>     
      <div class="form-group">
       ...
       <div class="field" id="pdf_tab">
        ...
        <div class="form-group">
          ...
          <div class="field">
             ...
             <input type="checkbox" name="cclass" value="三四年级" >三四年级
	         <input type="checkbox" name="cclass" value="五六年级" >五六年级
            <div class="tips"></div>
          </div>
        </div>
         <div class="form-group">
