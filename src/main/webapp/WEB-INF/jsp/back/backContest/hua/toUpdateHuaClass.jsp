...
<div class="panel admin-panel">
  <div class="panel-head" id="add"><strong><span class="icon-pencil-square-o"></span>修改华杯课程</strong></div>
  <div class="body-content">
    <form method="post" class="form-x" onsubmit="return sub()" enctype="multipart/form-data" action="${pageContext.request.contextPath}/back/updateHuaClass" >  
      <div class="form-group">
      <input type="hidden" value="${contestVideo.cid}" name="cid">
      <input type="hidden" value="华杯" name="competitionName">
        <div class="label">
          <label>课程名称：</label>
        </div>
        <div class="field">
