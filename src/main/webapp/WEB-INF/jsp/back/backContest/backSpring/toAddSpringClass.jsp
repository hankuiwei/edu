...
<div class="panel admin-panel">
  <div class="panel-head" id="add"><strong><span class="icon-pencil-square-o"></span>增加迎春杯课程</strong></div>
  <div class="body-content">
    <form method="post" class="form-x" onsubmit="return sub()" enctype="multipart/form-data" action="${pageContext.request.contextPath}/back/backSpring/addSpringClass" >  
      <div class="form-group">
       ...
       <div class="firminfo-video">
            <div class="firminfo-video-input">
                ...
                <input type="file" class="videoUp" id="videoUp" value=""  id="videoUp" style="display: none" data-validate="required:请上传视频" name="file1">
            </div>
        </div>
      </div>   
      <div class="form-group">
      ...
      <div class="form-group">
       ...
       <div class="field" id="pdf_tab">
        ...
        <div class="form-group">
          ...
          <div class="field">
                   <input type="checkbox" name="cclass" value="三年级">三年级
	               <input type="checkbox" name="cclass" value="四年级" >四年级
	               <input type="checkbox" name="cclass" value="五年级" >五年级
	               <input type="checkbox" name="cclass" value="六年级" >六年级
            <div class="tips"></div>
          </div>
        </div>
         <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value=""  name="cmoney" placeholder="如果免费则不需要填写该项" />
          <div class="tips"></div>
        </div>
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <div class="field">
          <textarea class="input" name="cintro" cols="100" rows="15" style="width:800px;height:300px;visibility:hidden;"></textarea>
          <div class="tips"></div>
        </div>
      </div>
      <div class="clear"></div>
