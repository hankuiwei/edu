...
<meta charset="utf-8" />
    ...
    <script type="text/javascript">
    	$(function(){var host=window.location.host;$("input[name='surl']").val(host);})
    </script>
</head>
<body>
  ...
  <div class="body-content">
    <form method="post" class="form-x" action="">
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input" name="stitle" value="厚朴教育"  disabled="disabled"/>
          <div class="tips"></div>
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input" name="surl" value="" disabled="disabled"/>
        </div>
      </div>
      <div class="form-group">
        <div class="label">
        ...
        <div class="field">
          <input type="text" class="input" name="s_name" value="QY" disabled="disabled" />
          <div class="tips"></div>
        </div>
      </div>
    </form>
