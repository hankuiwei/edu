...
<div class="panel admin-panel">
  <div class="panel-head" id="add"><strong><span class="icon-pencil-square-o"></span>修改语文测验</strong></div>
  <div class="body-content">
    <form method="post" class="form-x" onsubmit="return sub()" enctype="multipart/form-data" action="${pageContext.request.contextPath}/back/updateExam" >  
      <div class="form-group">
      <input type="hidden" value="${exam.etid}" name="etid">
      <input type="hidden" value="语文测验" name="etsubject">
        <div class="label">
          <label>课程名称：</label>
        </div>
        <div class="field">
