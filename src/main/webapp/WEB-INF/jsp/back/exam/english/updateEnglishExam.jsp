...
<div class="panel admin-panel">
  <div class="panel-head" id="add"><strong><span class="icon-pencil-square-o"></span>修改英语测验</strong></div>
  <div class="body-content">
    <form method="post" class="form-x" onsubmit="return sub()" enctype="multipart/form-data" action="${pageContext.request.contextPath}/back/updateEnglishExam" >  
      <div class="form-group">
      <input type="hidden" value="${exam.etid}" name="etid">
      <input type="hidden" value="英语测验" name="etsubject">
        <div class="label">
          <label>课程名称：</label>
        </div>
        <div class="field">
    ...
    <div class="form-group">
       ...
       <div class="form-group">
        ...
        <%--    <div class="form-group">
          ...
          <div class="field">
            <select name="etclass" class="input w50" data-validate="required:请选择所属年级">
         ...
         <div class="form-group">
          ...
          <div class="field">
            <select name="etclassify"  class="w50"  style="height:36px;line-height:34px;" id="etclassify" data-validate="required:请选择所属分类">
              ...
              <option value="三至六年级" <c:if test="${exam.etclass=='三至六年级' }">selected="selected"</c:if>>三至六年级</option>
            </select>
            <div class="tips"></div>
          </div>
        </div> 
        <%--  <div class="form-group">
          ...
          <div class="field">
            <select name="etclassify" class="input w50" data-validate="required:请选择所属分类">
              <option value="">--请选择类别--</option>
...
function sub(){
	var flag=false
	 ...
	 if($("#etclassify option:selected").val()==0){
		 sub3();
	 }else{
		 flag=true;
	 }
