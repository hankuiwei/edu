...
<div class="panel admin-panel">
  ...
  <div class="body-content">
    <form method="post" class="form-x" onsubmit="return sub()"  action="${pageContext.request.contextPath}/back/teacherUpdate" enctype="multipart/form-data">  
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value="${teacher.tname}" id="tname" name="tname" data-validate="required:请输入教师姓名" />
          <div class="tips"></div>
        </div>
      </div>
       <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" name="subject" id="subject"  value="${teacher.subject}" data-validate="required:请输入教授科目" />
          <div class="tips"></div>
        </div>
      </div>
       <%--  <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" name="title" value="${teacher.title}" placeholder="教师称谓" />
          <div class="tips"></div>
        </div>
      </div> --%>
      <div class="form-group">
        ...
        <img id="preview" alt="" name="pic"   src="${teacher.timgUrl}" style="width: 150px;height: 120px;" >
        </c:if>
       ...
       <div class="form-group">
        ...
        <img id="preview2" alt="" name="pic"   src="${teacher.backImg}" style="width: 150px;height: 120px;" >
        </c:if>
      ...
      <div class="form-group">
        ...
        <div class="field">
          <textarea class="input" name="tintro"  id="tintro" cols="100" rows="15" style="width:800px;height:300px;visibility:hidden;">${teacher.tintro}</textarea>
          <div class="tips"></div>
        </div>
      </div>
      <div class="clear"></div>
