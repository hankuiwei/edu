...
<!-- logo图 和搜素-->
	...
	<script type="text/javascript">
      function pageSize(num){
			window.location.href="${pageContext.request.contextPath}/order/stuList.html?pageNo="+num;
		}
	 //根据id显示学员信息
	  function showStu(id){
...
<script type="text/javascript" src="${pageContext.request.contextPath}/jsp/js/class.js?v=1"></script>
