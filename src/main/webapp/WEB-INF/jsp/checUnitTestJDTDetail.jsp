...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/jsp/css/public.css"/>
...
<body>
 ...
 <c:forEach items="${jdt_list}" var="jdt" varStatus="st">
    ...
    <div style="width:100%;word-break:break-all;margin-top:5px;;padding-left:10px;">
       您的回答：<textarea class="input"  style="width:600px;height:120px;"  readonly="readonly">${not empty jdt.stuAnswer?jdt.stuAnswer:'此题您没有作答'}</textarea>
    </div>
    <div style="width:100%;margin-top:5px;padding-left:10px;">
     <p>您的得分：<font style="color:#CE0221;font-size:16px;font-weight:bold;text-decoration: underline;">${not empty jdt.stuGotScore?jdt.stuGotScore:'&nbsp;&nbsp;&nbsp;&nbsp;'}</font></p>
