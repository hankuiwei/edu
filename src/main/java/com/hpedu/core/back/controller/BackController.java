...
import com.hpedu.core.user.controller.CommUtil;
...
public class BackController {
	...
	@RequestMapping("/back/backindex.html")
	public String toBackIndex(HttpServletRequest req, HttpSession session, Model model) throws Exception {
	...
	public void toInfo(HttpServletRequest req, HttpSession session, Model model) throws Exception {
		User user = (User) session.getAttribute("backuser");
		if (user != null) {
			model.addAttribute("backuser", user);
		}
	...
	public void toTeacher(HttpServletRequest req, HttpSession session, Model model) throws Exception {
	...
	public void searchAllGeneralChinese(HttpServletRequest req, HttpSession session, Model model) throws Exception {
	...
	public void toaddChineseGeneralVideo(HttpServletRequest req, HttpSession session, Model mode) throws Exception {
	...
	public void searchAllMathGeneralVideo(HttpServletRequest req, HttpSession session, Model model) throws Exception {
		Map<String, String> maps = new HashMap<String, String>();
		Page<GeneralVideo> pages = null;
		try {
			int pageNo = 0;
	...
	public void searchScienceGeneralVideo(HttpServletRequest req, HttpSession session, Model model) throws Exception {
		Map<String, String> maps = new HashMap<String, String>();
		Page<GeneralVideo> pages = null;
		try {
			int pageNo = 0;
	...
	public void toAddMathGeneral(HttpServletRequest req, HttpSession session, Model mode) throws Exception {
		if (session.getAttribute("error") != null) {
			mode.addAttribute("error", session.getAttribute("error"));
			session.removeAttribute("error");
		}
	...
	public void addScienceGeneral(HttpServletRequest req, HttpSession session, Model mode) throws Exception {
		if (session.getAttribute("error") != null) {
			mode.addAttribute("error", session.getAttribute("error"));
			session.removeAttribute("error");
		}
	...
	public void upload(Long orgId, HttpServletRequest request, HttpServletResponse response, Integer type)
			throws IOException {
		...
		try {
			...
			filePath = upload(request, dir, isVideo);
		} catch (Exception e) {
	 ...
	 * @throws Exception
	 */
	private String upload(HttpServletRequest request, String dir, boolean isVideo) throws Exception {
...
//			String path = req.getContextPath().substring(1);
			...
			for (int i = 0; i < files.length; i++) {
				...
				if (file.getSize() > 0) {
					...
					FileUtils.copyInputStreamToFile(file.getInputStream(), new File(realPath_c, name));
					url = "/" + dir + "/" + name;
				}
				if (i == 0) {// 封面图片 
...
//					vc.setSort(String.valueOf(sort + i));
	...
	public void searchAllEnglishGeneral(HttpServletRequest req, HttpSession session, Model model) throws Exception {
		Map<String, String> maps = new HashMap<String, String>();
		Page<GeneralVideo> pages = null;
		try {
			int pageNo = 0;
	...
	public void toAddEnglishGeneral(HttpServletRequest req, HttpSession session, Model mode) throws Exception {
		if (session.getAttribute("error") != null) {
			mode.addAttribute("error", session.getAttribute("error"));
			session.removeAttribute("error");
		}
	...
	public void updateVideoMore(HttpServletRequest req, HttpSession session, String gid, Model mode) throws Exception {
		GeneralVideo generalVideo = null;
		if (gid != null && !"".equals(gid)) {
			try {
				generalVideo = generalVideoService.findGeneralVideoByVid(gid);
	...
	public ModelAndView deleteEnglishGeneralByid(HttpServletRequest req, HttpSession session, String gid,
			Integer isMore) throws Exception {
		User user = (User) session.getAttribute("backuser");
		if (null != gid && !"".equals(gid)) {
			if (null != user) {
				try {
	...
	public void tobackUsaClass(HttpServletRequest req, HttpSession session, Model model) throws Exception {
	...
	public void toAddUSAClass(HttpServletRequest req, HttpSession session, Model mode) throws Exception {
		if (session.getAttribute("error") != null) {
			mode.addAttribute("error", session.getAttribute("error"));
			session.removeAttribute("error");
		}
	...
	public void toUpdateUSAClass(HttpServletRequest req, HttpSession session, Model mode, String cid) throws Exception {
	...
	public ModelAndView deleteUSACLass(HttpServletRequest req, HttpSession session, String cid) throws Exception {
		User user = (User) session.getAttribute("backuser");
		if (cid != null && !"".equals(cid)) {
			if (null != user) {
				try {
	...
	public void tobackSpringClass(HttpServletRequest req, HttpSession session, Model model) throws Exception {
		Page<ContestVideo> pages = null;
		Map<String, String> maps = new HashMap<String, String>();
		try {
			int pageNo = 0;
	...
	public ModelAndView deleteSpringCLass(HttpServletRequest req, HttpSession session, String cid) throws Exception {
		User user = (User) session.getAttribute("backuser");
		if (cid != null && !"".equals(cid)) {
			if (null != user) {
				try {
	...
	public void toAddSpringClass(HttpServletRequest req, HttpSession session, Model mode) throws Exception {
	...
	public void tobackHuaClass(HttpServletRequest req, HttpSession session, Model model) throws Exception {
		Page<ContestVideo> pages = null;
		Map<String, String> maps = new HashMap<String, String>();
		try {
			int pageNo = 0;
	...
	public ModelAndView deleteHuaCLass(HttpServletRequest req, HttpSession session, String cid) throws Exception {
		User user = (User) session.getAttribute("backuser");
	...
	public void toAddHuaClass(HttpServletRequest req, HttpSession session, Model mode) throws Exception {
		if (session.getAttribute("error") != null) {
			mode.addAttribute("error", session.getAttribute("error"));
			session.removeAttribute("error");
		}
	...
	public void toUpdateHuaClass(HttpServletRequest req, HttpSession session, Model mode, String cid) throws Exception {
		ContestVideo contestVideo = null;
		if (cid != null && !"".equals(cid)) {
			try {
				contestVideo = contestVideoService.findContestVideoById(cid);
	...
	public void backExam(HttpServletRequest req, HttpSession session, Model model) throws Exception {
	...
	public void toAddExamAll(HttpServletRequest req, HttpSession session, Model mode, String subject) throws Exception {
		if (session.getAttribute("error") != null) {
			mode.addAttribute("error", session.getAttribute("error"));
			session.removeAttribute("error");
		}
	...
	public ModelAndView addExamClass(HttpServletRequest req, HttpSession session,
			@RequestParam(value = "fm", required = false) MultipartFile fm, Exam exam) throws Exception {
	...
	public void updateExamAll(HttpServletRequest req, HttpSession session, Model mode, String gid) throws Exception {
		if (gid != null && !"".equals(gid)) {
			try {
...
//		realPath = realPath.replace(path, "examImg");
		...
		if (fm != null) {
			if (fm.getSize() > 0) {
				...
				FileUtils.copyInputStreamToFile(fm.getInputStream(), new File(realPath, fileName + "." + suffix));
	...
	public ModelAndView deleteExamById(HttpServletRequest req, HttpSession session, String gid) throws Exception {
		User user = (User) session.getAttribute("backuser");
		if (gid != null && !"".equals(gid)) {
			if (null != user) {
				try {
	...
	public void toUpdateExamById(HttpServletRequest req, HttpSession session, Model mode, String gid) throws Exception {
		if (gid != null && !"".equals(gid)) {
			try {
				Exam exam = examService.findExamByEtid(gid);
	...
	public void toAddExam(HttpServletRequest req, HttpSession session, Model mode) throws Exception {
		if (session.getAttribute("error") != null) {
			mode.addAttribute("error", session.getAttribute("error"));
			session.removeAttribute("error");
		}
	...
	public ModelAndView addExam(HttpServletRequest req, HttpSession session,
			@RequestParam(value = "fm", required = false) MultipartFile[] fm,
			@RequestParam(value = "file1", required = false) MultipartFile[] files,
			@RequestParam(value = "file1a", required = false) MultipartFile[] afiles, Exam exam) throws Exception {
		User user = (User) session.getAttribute("backuser");
		if (user != null) {
			try {
...
//		realPath = realPath.replace(path, "examImg");
			...
			for (int i = 0; i < fm.length; i++) {// 测验试卷题、答案pdf文件
				...
				if (file.getSize() > 0) {
					...
					FileUtils.copyInputStreamToFile(file.getInputStream(),
							new File(realPath, i == 0 ? fileName + "." + suffix : fileName));
					if (i == 0) {// 题pdf
	...
	public void backMathExam(HttpServletRequest req, HttpSession session, Model model) throws Exception {
		Page<Exam> pages = null;
		Map<String, String> maps = new HashMap<String, String>();
		try {
			int pageNo = 0;
	...
	public ModelAndView deleteMathExamById(HttpServletRequest req, HttpSession session, String gid) throws Exception {
		User user = (User) session.getAttribute("backuser");
		if (gid != null && !"".equals(gid)) {
			if (null != user) {
				try {
	...
	public void toAddMathExam(HttpServletRequest req, HttpSession session, Model mode) throws Exception {
		if (session.getAttribute("error") != null) {
			mode.addAttribute("error", session.getAttribute("error"));
			session.removeAttribute("error");
		}
	...
	public void backEnglishExam(HttpServletRequest req, HttpSession session, Model model) throws Exception {
		Page<Exam> pages = null;
		Map<String, String> maps = new HashMap<String, String>();
		try {
			int pageNo = 0;
	...
	public void toAddEnglishExam(HttpServletRequest req, HttpSession session, Model mode) throws Exception {
	...
	public void bannerMgr(HttpServletRequest req, HttpSession session, Model model) throws Exception {
		try {
	...
	public ModelAndView deleteBanner(HttpServletRequest req, HttpSession session, String bid) throws Exception {
		try {
	...
	public void updateBanner(HttpServletRequest req, HttpSession session, String bid, Model mode) throws Exception {
		try {
				...
				for (MultipartFile f : file2) {
					if (f.getSize() > 0) {
						...
						FileUtils.copyInputStreamToFile(f.getInputStream(),
								new File(realPath, fileName + "." + suffix));
	...
	public void toAddBanner(HttpServletRequest req, HttpSession session, Model mode) throws Exception {
	...
	public void userMgr(HttpServletRequest req, HttpSession session, Model model) throws Exception {
		Map<String, String> maps = new HashMap<String, String>();
	...
	public void userMgrComm(HttpServletRequest req, HttpSession session, Model model) throws Exception {
		Map<String, String> maps = new HashMap<String, String>();
		maps.put("type", "0");
		int pageNo = 0;
		int pageSize = 20;
	...
	public ModelAndView deleteCommUser(HttpServletRequest req, HttpSession session, String uid) throws Exception {
		try {
	...
	public ModelAndView deleteUser(HttpServletRequest req, HttpSession session, String uid) throws Exception {
		try {
			userService.deleteUserById(uid);
		} catch (Exception e) {
	...
	public void updateUser(HttpServletRequest req, HttpSession session, String uid, int userType, Model model)
		...
		try {
			...
			String json = JSONArray.fromObject(userService.selectRightMenu("")).toString();
	...
	public ModelAndView updateUserClass(HttpServletRequest req, HttpSession session, User user, String endTime2,
			Integer isSend, int userType) throws Exception {
		try {
			user.setStatus(1);
			Date endDate = null;
			String res = "";
			...
			try {
				...
				if (isSend == 1) {
					// 发短信提醒用户审核通过
					res = CommUtil.sendSMS(user.getPhoneNo(), session, false, userType);// userType:1：重审短信；0：注册审核短信
	...
	public void adminMgr(HttpServletRequest req, HttpSession session, Model model) throws Exception {
		Map<String, String> maps = new HashMap<String, String>();
		maps.put("isVip", "2");
		try {
	...
	public void userLevel(HttpServletRequest req, HttpSession session, Model model) throws Exception {
		try {
	...
	public ModelAndView deleteUserLevel(HttpServletRequest req, HttpSession session, String ulid) throws Exception {
		try {
	...
	public void userLevelAdd(HttpServletRequest req, HttpSession session, Model model) throws Exception {
	...
	public ModelAndView userLevelAddClass(HttpServletRequest req, HttpSession session, UserLevel user, String level,
			String minNum) throws Exception {
		try {
	...
	public void userLevelUp(HttpServletRequest req, HttpSession session, String ulid, Model mode) throws Exception {
		try {
	...
	public ModelAndView deleteAdmin(HttpServletRequest req, HttpSession session, String uid) throws Exception {
		try {
			userService.deleteUserById(uid);
		} catch (Exception e) {
	...
	public void toAddAdmin(HttpServletRequest req, HttpSession session, Model model) throws Exception {
	...
	public ModelAndView addAdminClass(HttpServletRequest req, HttpSession session, User user) throws Exception {
		try {
	...
	public void addUnitTest(HttpServletRequest req, HttpSession session, Model mode, String vid, String vname,
			String type, String typeName) throws Exception {
		try {
			Map<String, Object> map = new HashMap<String, Object>();
			map.put("vid", vid);
			map.put("utype", type);
		...
		if (user != null) {
			try {
				...
				if (uc.getIsHasJDT() != 0) {
					try {
						// 批量新增学生简答题答案
						List<Map<String, String>> JDT_answer = (List<Map<String, String>>) JSONArray
								.toList(JSONArray.fromObject(req.getParameter("JDT_answer")), Map.class);
	...
	public void correctIndex(HttpServletRequest req, HttpSession session, Model mode) throws Exception {
	...
	public void addExams(HttpServletRequest req, HttpSession session, Model mode, String etid) throws Exception {
		try {
